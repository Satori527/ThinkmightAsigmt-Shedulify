...
export default function Calendar(bookingTimes,length,meetingUri,username) {
    ...
    const weekdaysShortNames = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"];
    ...
    const bookingHours = [];
    if (selectedDay) {
        const weekdayNameIndex = format(selectedDay, "EEEE").toLowerCase();
    ...
    return (
        ...
        <div className="p-8">
            ...
            {daysNumbers.map(n => {
                const weekdayNameIndex = format(n, "EEEE").toLowerCase();
